...
(xbindkey '(control Mod1 q) "chromium")

;;(xbindkey '(control Mod1 c) "firefox-2")
;;(xbindkey '(control Mod1 w) "firefox")
(xbindkey '(control Mod1 w) "firefox")
;;(xbindkey '(control Mod1 r) "pidgin")
(xbindkey '(control Mod1 o) "jedit")
(xbindkey '(control Mod1 e) "/home/fox/programs/scripts/networking/start_rdesktop.sh")

(xbindkey '(control Mod1 a) "/home/fox/eclipse/eclipse")
;;(xbindkey '(control Mod1 s) "/home/fox/programs/datastudio/datastudio.sh")
;;(xbindkey '(control Mod1 s) "deluge")
(xbindkey '(control Mod1 c) "wine /home/fox/Downloads/utorrent.exe")
(xbindkey '(control Mod1 s) "skype")

;;(xbindkey '(control Mod1 z) "xclock")
(xbindkey '(control Mod1 z) "libreoffice")

(xbindkey '(control Mod1 d) "evince")
(xbindkey '(control shift Mod1 q) "qcomicbook")
;;(xbindkey '(control Mod1 d) "gnome-terminal")

(xbindkey '(control shift q) "xbindkeys_show")
(xbindkey '(control Mod1 p) "xlock")
